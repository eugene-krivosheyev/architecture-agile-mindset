...
- стоимость добавления структур данных vs стоимость добавления поведения vs необходимость изменений существующей системы
